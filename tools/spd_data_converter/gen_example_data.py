...
def copy_dataset(input_dataset_path, output_dataset_path, update_label):
    ...
    os.system(f"cp -r {input_dataset_path}/vehicle-side/calib {output_dataset_path}/vehicle-side/calib")
    os.system(f"cp -r {input_dataset_path}/vehicle-side/image {output_dataset_path}/vehicle-side/image")
    os.system(f"cp -r {input_dataset_path}/vehicle-side/velodyne {output_dataset_path}/vehicle-side/velodyne")
    ...
    os.system(f"cp -r {input_dataset_path}/infrastructure-side/calib {output_dataset_path}/infrastructure-side/calib")
    os.system(f"cp -r {input_dataset_path}/infrastructure-side/image {output_dataset_path}/infrastructure-side/image")
    os.system(f"cp -r {input_dataset_path}/infrastructure-side/velodyne {output_dataset_path}/infrastructure-side/velodyne")
    ...
    os.system(f"cp -r {input_dataset_path}/vehicle-side/calib {output_dataset_path}/cooperative/calib")
    os.system(f"cp -r {input_dataset_path}/vehicle-side/image {output_dataset_path}/cooperative/image")
    os.system(f"cp -r {input_dataset_path}/vehicle-side/velodyne {output_dataset_path}/cooperative/velodyne")
    os.system(f"cp -r {input_dataset_path}/maps {output_dataset_path}/maps")

    os.system(f"cp -r {input_dataset_path}/vehicle-side/calib {output_dataset_path}/cooperative/vehicle-side/calib")
    os.system(f"cp -r {input_dataset_path}/vehicle-side/image {output_dataset_path}/cooperative/vehicle-side/image")
    os.system(f"cp -r {input_dataset_path}/vehicle-side/velodyne {output_dataset_path}/cooperative/vehicle-side/velodyne")
    os.system(f"cp -r {input_dataset_path}/infrastructure-side/calib {output_dataset_path}/cooperative/infrastructure-side/calib")
    os.system(f"cp -r {input_dataset_path}/infrastructure-side/image {output_dataset_path}/cooperative/infrastructure-side/image")
    os.system(f"cp -r {input_dataset_path}/infrastructure-side/velodyne {output_dataset_path}/cooperative/infrastructure-side/velodyne")
